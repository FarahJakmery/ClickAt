                            ...
                            <div class="container">
                                <div class="forms-container">
                                    <div class="signin-signup">
                                        <form action="{{ route('user.checkout') }}" class="sign-up-form" method="POST">
                                            {{ csrf_field() }}
                                            <h2 class="title">معلومات التوصيل</h2>
                                            ...
                                            <div class="input-field">
                                                ...
                                                <input name="mobile_number" id="mobile_number"
                                                    value="{{ $user->mobile_number }}" type="text"
                                                    placeholder="رقم الهاتف" />
                                            </div>
                                            @if (\App\Models\Address::where('user_id', auth()->id())->exists())
                                                <h6 class="input-title">عنوان الدفع</h6>
                                                <div class="input-container">
                                                    ...
                                                    <div class="input-field">
                                                        <i class="fas fa-location-arrow"></i>
                                                        <input value="{{ $user->address->city1 }}" name="city1" id="city1"
                                                            type="text" placeholder="المدينة" />
                                                    </div>
                                                </div>
                                                <div class="input-container">
                                                    <div class="input-field">
                                                        <i class="fas fa-location-arrow"></i>
                                                        <input value="{{ $user->address->state1 }}" name="state1"
                                                            id="state1" type="text" placeholder="المنطقة" />
                                                    </div>
                                                    <div class="input-field">
                                                        <i class="fas fa-envelope"></i>
                                                        <input value="{{ $user->address->zip1 }}" name="zip1" id="zip1"
                                                            type="text" placeholder="ZIP" />
                                                    </div>
                                                </div>
                                                <div class="input-field">
                                                    <i class="fas fa-map-marker-alt"></i>
                                                    <input value="{{ $user->address->address1 }}" name="address1"
                                                        id="address1" type="text" placeholder="العنوان" />
                                                </div>
                                                <h6 class="input-title">عنوان التوصيل</h6>
                                                <div class="input-container">
                                                    <div class="input-field">
                                                        <i class="fas fa-location-arrow"></i>
                                                    ...
                                                    <div class="input-field">
                                                        <i class="fas fa-location-arrow"></i>
                                                        <input value="{{ $user->address->city2 }}" name="city2" id="city2"
                                                            type="text" placeholder="المدينة" />
                                                    </div>
                                                </div>
                                                <div class="input-container">
                                                    <div class="input-field">
                                                        <i class="fas fa-location-arrow"></i>
                                                        <input value="{{ $user->address->state2 }}" name="state2"
                                                            id="state2" type="text" placeholder="المنطقة" />
                                                    </div>
                                                    <div class="input-field">
                                                        <i class="fas fa-envelope"></i>
                                                        <input value="{{ $user->address->zip2 }}" name="zip2" id="zip2"
                                                            type="text" placeholder="ZIP" />
                                                    </div>
                                                </div>
                                                <div class="input-field">
                                                    <i class="fas fa-map-marker-alt"></i>
                                                    <input value="{{ $user->address->address2 }}" name="address2"
                                                        id="address2" type="text" placeholder="العنوان" />
                                                </div>
                                            @else
                                                <h6 class="input-title">عنوان الدفع</h6>
                                                <div class="input-container">
                                                ...
                                                <div class="input-container">
                                                    <div class="input-field">
                                                        <i class="fas fa-location-arrow"></i>
                                                        <input name="state1" id="state1" type="text"
                                                            placeholder="المنطقة" />
                                                    </div>
                                                    <div class="input-field">
                                                        <i class="fas fa-envelope"></i>
                                                ...
                                                <div class="input-container">
                                                    <div class="input-field">
                                                        <i class="fas fa-location-arrow"></i>
                                                        <input name="state2" id="state2" type="text"
                                                            placeholder="المنطقة" />
                                                    </div>
                                                    <div class="input-field">
                                                        <i class="fas fa-envelope"></i>
                                            ...
                                            @endif
                                            <button type="submit" class="btn" value="نأكيد">تأكيد الدفع</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
