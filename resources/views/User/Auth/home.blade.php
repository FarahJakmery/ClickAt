                ...
                <div class="col-md-4">
                    <div class="top-cat-banner-item yellow mt-20 main-section">
                        <a href="shop-left-sidebar.html">
                            ...
                            <img class="img-height-l" src="{{ URL::asset('Web/assets/img/header-section/clothes.jpg') }}"
                                alt="">
                        </a>
                    </div>
                </div>
                            ...
                            <div class="top-cat-banner-item dark-gray mt-20 secondry-section">
                                <a href="shop-left-sidebar.html">
                                    ...
                                    <img class="img-height-s"
                                        src="{{ URL::asset('Web/assets/img/header-section/cars.jpg') }}" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-12 col-xs-12">
                            <div class="top-cat-banner-item lite-red mt-20 secondry-section">
                                <a href="shop-left-sidebar.html">
                                    ...
                                    <img class="img-height-s"
                                        src="{{ URL::asset('Web/assets/img/header-section/electronics.jpg') }}" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12 col-xs-6">
                            <div class="top-cat-banner-item dark-gray mt-20 secondry-section">
                                <a href="shop-left-sidebar.html">
                                    ...
                                    <img class="img-height-s"
                                        src="{{ URL::asset('Web/assets/img/header-section/furniture.jpg') }}" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-12 col-xs-6">
                            <div class="top-cat-banner-item lite-red mt-20 secondry-section">
                                <a href="shop-left-sidebar.html">
                                    ...
                                    <img class="img-height-s"
                                        src="{{ URL::asset('Web/assets/img/header-section/ketchen.jpg') }}" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row exclusive-active">
                        ...
                        <div class="col-lg-4 col-sm-6 grid-item grid-sizer cat-one cat-two">
                            <div class="exclusive-item mb-40">
                                <div class="exclusive-item-thumb exclusive-item-three">
                                    <a href="shop-details.html">
                                        {{-- <img src="{{ URL::asset('Web/assets/img/products/Men's-Casual-Shoes.jpg') }}" alt=""> --}}
                                    </a>
                                </div>
                                <div class="exclusive-item-content">
                                    <div class="exclusive--content--bottom">
                            ...
                            <div class="ko-progress-circle data-left-time" data-progress="0"
                                ...
                                <div class="ko-progress-circle__overlay">
                                    <div class="most--popular--item--thumb height-100 circle-shape">
                                        <a href="#"><img
                                                src="{{ URL::asset('Web/assets/img/products/Beard-Trimmer.jpg') }}"
                                                alt=""></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="exclusive-item-thumb circle-shape">
                            <div class="ko-progress-circle data-left-time" data-progress="0"
                                ...
                                <div class="ko-progress-circle__overlay">
                                    <div class="most--popular--item--thumb height-100 circle-shape">
                                        <a href="#"><img
                                                src="{{ URL::asset('Web/assets/img/products/party-dress.jpg') }}"
                                                alt=""></a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="exclusive-item exclusive-item-three text-center mb-40">
                        <div class="exclusive-item-thumb circle-shape">
                            <div class="ko-progress-circle data-left-time" data-progress="0"
                                ...
                                <div class="ko-progress-circle__overlay">
                                    <div class="most--popular--item--thumb height-100 circle-shape">
                                        {{-- <a href="#"><img src="{{ URL::asset('Web/assets/img/products/Men's-Casual-Shoes.jpg') }}" alt=""></a> --}}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="exclusive-item-thumb circle-shape">
                            <div class="ko-progress-circle data-left-time" data-progress="0"
                                ...
                                <div class="ko-progress-circle__overlay">
                                    <div class="most--popular--item--thumb height-100 circle-shape">
                                        <a href="#"><img
                                                src="{{ URL::asset('Web/assets/img/products/Stylish-Smart-Watch.jpg') }}"
                                                alt=""></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3">
                            <div class="most-popular-viewed-item mb-30">
                                <div class="viewed-item-top">
                                    <div class="most--popular--item--thumb mb-20">
                                        <a href="#"><img
                                                src="{{ URL::asset('Web/assets/img/products/Venam-Beard-Laptop.jpg') }}"
                                                alt=""></a>
                                    </div>
                                    <div class="super-deal-content">
        ...
        <div class="container">
            ...
            <div class="row testimonial-active">
                <div class="col-xl-4">
                    <div class="testimonial-item text-center">
                        <div class="testi-avatar-img mb-20">
                            <img src="{{ URL::asset('Web/assets/img/logo/amazon.jpg') }}" alt="">
                        </div>
                ...
                <div class="col-xl-4">
                    <div class="testimonial-item text-center">
                        <div class="testi-avatar-img mb-20">
                            <img src="{{ URL::asset('Web/assets/img/logo/ali-baba.jpg') }}" alt="">
                        </div>
                        <div class="testi-avatar-info">
                            <h5>علي بابا</h5>
                            <a class="copy-code" herf="#">انسخ الرمز</a>
                ...
                <div class="col-xl-4">
                    <div class="testimonial-item text-center">
                        <div class="testi-avatar-img mb-20">
                            <img src="{{ URL::asset('Web/assets/img/logo/Ali-express.png') }}" alt="">
                        </div>
                        <div class="testi-avatar-info">
                            <h5>علي اكسبريس</h5>
                            <a class="copy-code" herf="#">انسخ الرمز</a>
                ...
                <div class="col-xl-4">
                    <div class="testimonial-item text-center">
                        <div class="testi-avatar-img mb-20">
                            <img src="{{ URL::asset('Web/assets/img/logo/noon.png') }}" alt="">
                        </div>
                        <div class="testi-avatar-info">
                            <h5>نون</h5>
                            <a class="copy-code" herf="#">انسخ الرمز</a>
