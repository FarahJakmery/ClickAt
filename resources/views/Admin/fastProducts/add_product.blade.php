                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="number" class="form-control" id="product_number"
                                            name="product_number" data-bs-placement="bottom" data-bs-toggle="tooltip"
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input aria-label="Amount (to the nearest dollar)" class="form-control"
                                                type="text" id="max_price" name="max_price" data-bs-placement="bottom"
                                                data-bs-toggle="tooltip" title="يرجى ادخال السعر الأقصى للمنتج">
                                            <div class="input-group-text">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input aria-label="Amount (to the nearest dollar)" class="form-control"
                                                type="text" id="min_price" name="min_price" data-bs-placement="bottom"
                                                data-bs-toggle="tooltip" title="يرجى ادخال السعر الأدنى للمنتج">
                                            <div class="input-group-text">
                                                <span class="input-group-text">$</span>
                                            </div>
                                        </div>
